...
export default function EditorPage() {
  ...
  return (
    ...
    >
      ...
      <div
        data-canvas-area
        className="flex-none h-[48dvh] md:h-full md:flex-1 relative bg-gradient-to-br from-zinc-100 via-zinc-50 to-zinc-100 dark:from-zinc-950 dark:via-black dark:to-zinc-900 overflow-hidden transition-colors duration-300"
      >
